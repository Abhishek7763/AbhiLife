...
export const AREA_STATES = Object.freeze([
  'not_assessed', 'on_track', 'maintaining', 'needs_attention', 'blocked', 'no_current_focus'
]);

export const GOAL_STATES = Object.freeze([
  'inbox', 'investigating', 'defined', 'someday', 'active', 'paused', 'completed', 'dropped'
]);

export const GOAL_PRIORITIES = Object.freeze(['low', 'medium', 'high']);
export const INBOX_THOUGHT_STATES = Object.freeze(['inbox', 'investigating', 'accepted', 'someday', 'archived']);
export const INVESTIGATION_QUESTION_KEYS = Object.freeze(['origin', 'why', 'outcome', 'cost', 'process', 'control', 'timing', 'conflict', 'commitment']);
...
export const MISSED_REASONS = Object.freeze([
  'forgot', 'no_time', 'low_energy', 'too_difficult', 'too_large', 'unclear', 'distraction', 'unexpected_work', 'not_important_now', 'other'
]);
